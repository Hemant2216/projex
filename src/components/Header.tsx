...
const Header = () => {
  return (
    <div className="px-[10%] py-16 grid grid-cols-1 lg:grid-cols-2 bg-gradient-to-b from-purple-700 to-pink-500 bg-blue">
      <div className="text-white p-2">
        <h1 className="font-extrabold text-5xl">
          ProjeX brings all your tasks, teammates, and tools together
        </h1>
